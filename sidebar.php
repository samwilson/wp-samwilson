...
<ol id="sidebar">
	...
	<li class="description">
		...
		<a rel="me" href="http://www.openstreetmap.org/user/Sam%20Wilson" title="Username: Sam Wilson">OpenStreetMap</a>,
	...
	<li>
		<form action="<?php esc_url( home_url( '/' ) ) ?>" method="get" role="search" class="search-form">
			<input type="search" placeholder="Search this site&hellip;" value="<?php get_search_query() ?>" name="s" id="s" class="search-field" />
	...
	<li class="osm">
		...
		<p>
			...
			to <a href="http://osm.org">OSM</a> since 29 April 2008; my username is 
			<a rel="me" href="http://www.openstreetmap.org/user/Sam%20Wilson" title="Username: Sam Wilson">Sam Wilson</a>.
		</p>
		<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
			src="http://www.openstreetmap.org/export/embed.html?bbox=115.72888612747192%2C-32.061518848030076%2C115.75785398483276%2C-32.04887945658629&amp;layer=mapnik"></iframe>
	</li>

	<li><h3>Categories</h3><dl><?php foreach (get_categories() as $cat): ?>
	<dt><a href=" <?php echo get_category_link($cat->term_id) ?>" title="<?php echo "View all posts in $cat->name" ?>">
	<?php echo $cat->name ?></a></dt><dd><?php echo $cat->description ?></dd>
	<?php endforeach ?></dl></li>
	...
	$request = "SELECT ID, post_title, MONTHNAME(post_date) AS `month`, YEAR(post_date) AS `year` "
		." FROM $wpdb->posts "
		." WHERE post_status = 'publish' AND post_password ='' AND post_type!='page'"
	...
	<li>
		...
		<ul><?php samwilson15_recent_comments() ?></ul>
	</li>
	...
	<li class="links">
		...
		<ul>
			...
			<li>
				...
				<ul class="blogroll">
					<li><a href="http://stackexchange.com/users/35218" title="My profile on Stack Exchange">
					<img src="http://stackexchange.com/users/flair/35218.png?theme=clean" width="208" height="58"
